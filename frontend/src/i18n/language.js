...
const ptToEn = {
  ...
  "Use seu usuÃ¡rio e senha para acessar o painel financeiro.": "Use your username and password to access the financial dashboard.",
  "Usuário": "Username",
  "UsuÃ¡rio": "Username",
  "Seu usuário": "Your username",
  "Seu usuÃ¡rio": "Your username",
  "Senha": "Password",
  "Sua senha": "Your password",
  "Entrar": "Sign in",
  "Entrando...": "Signing in...",
  "Validando sessão...": "Validating session...",
  "Validando sessÃ£o...": "Validating session...",
  "Painel financeiro": "Financial dashboard",
  "Controle de caixa em tempo real.": "Real-time cash control.",
  "Exportar": "Export",
  "Novo lançamento": "New entry",
  "Novo lanÃ§amento": "New entry",
  ...
  "Receita paga menos inadimplÃªncia e custos": "Paid revenue minus delinquency and costs",
  "Inadimplência + custos cadastrados": "Delinquency + registered costs",
  "InadimplÃªncia + custos cadastrados": "Delinquency + registered costs",
  "Fluxo de caixa": "Cash flow",
  "Entradas e saídas": "Income and expenses",
  "Entradas e saÃ­das": "Income and expenses",
  "Período": "Period",
  "Periodo": "Period",
  "Análise rápida": "Quick analysis",
  "AnÃ¡lise rÃ¡pida": "Quick analysis",
  "Índice de saúde": "Health score",
  "Ãndice de saÃºde": "Health score",
  ...
  "A anÃ¡lise serÃ¡ exibida assim que a base responder.": "The analysis will appear as soon as the database responds.",
  ...
  "Informacoes comerciais, cobranca, contrato...": "Commercial details, billing, contract...",
  ...
  "Somente arquivos PDF sao aceitos.": "Only PDF files are accepted.",
  ...
  "Novo produto ou serviÃ§o": "New product or service",
  "Nome": "First name",
  "Sobrenome": "Last name",
  "Descrição": "Description",
  ...
  "Produto ou serviÃ§o": "Product or service",
  ...
  "InÃ­cio do perÃ­odo": "Period start",
  "Fim do período": "Period end",
  "Fim do perÃ­odo": "Period end",
  "Gerar fatura": "Generate invoice",
  "Buscar por número": "Search by number",
  "Buscar por nÃºmero": "Search by number",
  ...
  "nao pode ser anterior ao inicio do periodo": "cannot be earlier than the period start",
  ...
  "Criar usuÃ¡rio": "Create user",
  "Editar": "Edit",
  "Salvar usuário": "Save user",
  "Salvar usuÃ¡rio": "Save user",
  "Cancelar edição": "Cancel editing",
  "Cancelar ediÃ§Ã£o": "Cancel editing",
  "Idioma": "Language",
...
function normalizePortuguese(value) {
  ...
  return Object.entries(fixes).reduce((text, [from, to]) => text.replaceAll(from, to), value);
}
...
function translateDynamic(text, language) {
  ...
  return text
    ...
    .replace(/^Periodo (.+) ate (.+)$/, "Period $1 to $2")
